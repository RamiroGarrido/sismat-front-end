...
@Component({
    selector: 'app-pie-chart-i',
    templateUrl: './piechartI.component.html'
})

export class PieChartIComponent implements OnInit {
                ...
                if (this.ordenesObtenidas != null) {
                    ...
                    let chart = new CanvasJS.Chart("chartContainer", {
                        ...
                        data: [{
                            ...
                            dataPoints: [
                                { y: this.CONTADOR_RECEPCIONADO, name: 'EJECUCION' },
